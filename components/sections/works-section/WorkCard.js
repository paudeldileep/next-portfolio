...
const WorkCard = (props) => {
  const { project } = props;
  return (
    <div className="w-2/3 md:w-1/2 mx-auto lg:w-1/3 lg:mx-10 flex flex-col my-10 h-96 shadow-sm rounded-md shadow-violet-500 dark:shadow-gray-50 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-md dark:hover:shadow-sm hover:shadow-violet-600 dark:hover:shadow-slate-200 overflow-hidden relative group">
      {/* overlay */}
